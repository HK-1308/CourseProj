...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseProj.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Email = "root",
                            Password = "NN/fKylIfrSYU+1CkhPbaA==",
                            RoleId = 1,
                            Unblocked = true,
                            salt = new byte[] { 218, 100, 28, 91, 22, 251, 149, 242 }
                        });
                });
            ...
            modelBuilder.Entity("ItemUser", b =>
                {
                    b.Property<int>("itemsFavoriteID")
                        .HasColumnType("int");

                    b.Property<int>("usersFavoriteID")
                        .HasColumnType("int");

                    b.HasKey("itemsFavoriteID", "usersFavoriteID");
            ...
            modelBuilder.Entity("ItemUser", b =>
                {
                    b.HasOne("CourseProj.Data.Models.Item", null)
                        .WithMany()
                        .HasForeignKey("itemsFavoriteID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CourseProj.Data.Models.User", null)
                        .WithMany()
